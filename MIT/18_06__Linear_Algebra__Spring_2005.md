...
以2x-y=0,-x+2y=3为例,其系数矩阵为A=\begin{bmatrix}2&-1\\-1&2\end{bmatrix},未知数向量为X=\begin{bmatrix}x\\y\end{bmatrix},常量向量为B=\begin{bmatrix}0\\3\end{bmatrix}。
...
如果A和B都是可逆矩阵,那么A*B的逆矩阵为B^-1 * A^-1,但需要注意顺序。
